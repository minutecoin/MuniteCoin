...
unlocked to sign the Mcoin-Qt.app bundle.
...
allowing somebody to distribute a Mcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the mcoin-qt.exe file inside the installer had not been tampered with.
